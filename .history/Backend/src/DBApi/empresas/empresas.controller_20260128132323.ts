...
export class EmpresasController {
  ...
  @Get('empresa/armados/:id')
  obtenerCursosArmadosDeEmpresa(@Param('id', ParseIntPipe) id_empresa: number) {
    return this.empresasService.obtenerCursosArmadosDeEmpresa(id_empresa)
  }
